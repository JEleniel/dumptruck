...
This document defines the comprehensive JSON report structure generated by Dumptruck's analyze command. All fields are designed for security operations, forensic analysis, and breach attribution.
...
- **file_id**: UUID v4 uniquely identifying this analysis run
- **file_sha256**: Content hash for integrity verification
- **operator**: User/service that performed the analysis
